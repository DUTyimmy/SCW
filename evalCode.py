...
def main():
    ...
    parser.add_argument('--save_dir', type=str, default=r"F:\ICCV_2021\submission\MF\experiments\densenet169-salmap")
    parser.add_argument('--gt_dir', type=str, default=r"G:\Dataset\2DSOD")
    args = parser.parse_args()

    gt_dir = args.gt_dir
    pred_dir = args.save_dir
    test_datasets = ['DUTS', 'ECSSD', 'DUT', 'HKU', 'PASCAL']
    ...
    for dataset in test_datasets:
        ...
        loader = eval_Dataset(osp.join(pred_dir, dataset), osp.join(gt_dir, dataset, 'mask'))

        data_loader = data.DataLoader(dataset=loader, batch_size=16, shuffle=False, num_workers=12, pin_memory=True,
